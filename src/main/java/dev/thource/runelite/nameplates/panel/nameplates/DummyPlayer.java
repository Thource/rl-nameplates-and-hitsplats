...
public class DummyPlayer implements Player {
    ...
    @Override
    public long getHash() { return -123L; }
    @Override
    ...
    @Override
    public boolean isInteracting() { return false; }
    @Override
    ...
    @Override
    public int getCurrentOrientation() { return 0; }
    @Override
    ...
    @Override
    public int getPoseAnimationFrame() { return 0; }
    @Override
    ...
    @Override
    public int getAnimationFrame() { return 0; }
    @Override
    public void setActionFrame(int frame) {}
    @Override
    public void setAnimationFrame(int frame) {}
    @Override
    public IterableHashTable<ActorSpotAnim> getSpotAnims() { return null; }
    @Override
    public boolean hasSpotAnim(int spotAnimId) { return false; }
    @Override
    ...
    @Override
    public int getGraphicHeight() { return 0; }
    @Override
    public void setGraphicHeight(int height) {}
    @Override
    public int getSpotAnimFrame() { return 0; }
    @Override
    public void setSpotAnimFrame(int spotAnimFrame) {}
    @Override
    public Polygon getCanvasTilePoly() { return null; }
    @Override
    public net.runelite.api.Point getCanvasTextLocation(Graphics2D graphics, String text, int heightOffset) { return null; }
    @Override
    public net.runelite.api.Point getCanvasImageLocation(BufferedImage image, int heightOffset) { return null; }
    @Override
    public net.runelite.api.Point getCanvasSpriteLocation(SpritePixels sprite, int heightOffset) { return null; }
    @Override
    public net.runelite.api.Point getMinimapLocation() { return null; }
    @Override
    ...
    @Override
    public String getOverheadText() { return ""; }
    @Override
    public void setOverheadText(String overheadText) {}
    @Override
    public int getOverheadCycle() { return 0; }
    @Override
    ...
    @Override
    public int getAnimationHeightOffset() { return 0; }
    @Override
    ...
    @Override
    public boolean isClanMember() { return false; }
    @Override
    public HeadIcon getOverheadIcon() { return dummyOverhead; }
    @Override
    public int getSkullIcon() { return dummySkull; }
    @Override
    public void setSkullIcon(int skullIcon) {}
    @Override
    public int getFootprintSize() { return 0; }
}
