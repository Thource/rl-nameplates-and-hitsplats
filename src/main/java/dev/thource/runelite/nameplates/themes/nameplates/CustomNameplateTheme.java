...
public class CustomNameplateTheme extends NameplateTheme {
    ...
    public static CustomNameplateTheme deserialize(String json, Gson gson) throws JsonSyntaxException, IllegalArgumentException {
        ...
        // We have to remove the elements before deserializing the theme itself, otherwise Gson will try to deserialize
        //   the elements as part of the theme and fail since it doesn't know about the element subclasses
