...
public class Rect extends Element {
    ...
    public Rect(String name, PositionProvider xPositionProvider, PositionProvider yPositionProvider, DimensionProvider widthProvider, DimensionProvider heightProvider, Color color) {
    ...
    public void draw(Nameplate nameplate, Graphics2D graphics, int x, int y, int plateWidth, int plateHeight) {
        ...
        Rect.draw(graphics, x + xPositionProvider.get(nameplate, plateWidth), y + yPositionProvider.get(nameplate, plateHeight), width, height, color);
    }
