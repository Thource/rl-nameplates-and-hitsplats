...
public class Icon extends Element {
    private static final BufferedImage NO_LOOT_IMAGE = ImageUtil.loadImageResource(NameplatesPlugin.class, "no_loot_indicator.png");
    ...
    protected transient final ImageFill imageFill = new ImageFill();
    ...
    public Icon(String name, PositionProvider xPositionProvider, PositionProvider yPositionProvider, DimensionProvider sizeProvider, IconType iconType) {
    ...
    private static BufferedImage getImage(Nameplate nameplate, IconType iconType, Direction direction) {
        switch (iconType) {
            case OVERHEAD:
    ...
    @Override
    public void draw(Nameplate nameplate, Graphics2D graphics, int x, int y, int plateWidth, int plateHeight) {
    ...
    public void draw(Nameplate nameplate, Graphics2D graphics, int x, int y, int plateWidth, int plateHeight, IconType iconType, Direction direction) {
